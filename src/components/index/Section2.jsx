export default function Section2() {
  return (
    <div className='py-[20vh] md:py-[30vh] px-10 md:px-0 mx-auto max-w-[800px] dark:bg-[#2f2f2f]'>
      <div className='md:columns-1 md:gap-8 px-2 md:px-4'>
        <p className='pb-4 md:pb-2'>
          <span className='font-bold'>cabanagem200</span> apresenta{' '}
          <span className='font-bold italic'>Nheenga Cabana</span>, um conjunto
          de trabalhos de Giseli Vasconcelos e Pedro Victor Brandão que trata da
          Revolução da Cabanagem, ocorrida durante o período regencial, no
          século XIX, quando diversas insurgências eclodiram no Brasil.
        </p>
        <p className='pb-4 md:pb-2'>
          O projeto foi comissionado pelo Museu de Arte Moderna do Rio de
          Janeiro para a exposição{' '}
          <a
            className='text-slate-700 font-bold hover:underline dark:text-slate-400'
        ...
        <p className='pb-4 md:pb-2'>
          ...
          <span className='font-bold italic'>Jornal Pessoal</span> de Lúcio
          sobre esse período e co-criamos imagens com versões iniciais de
        ...
        <p>
          ...
          extraordinária do{' '}
          <span className='font-bold italic'>Jornal Pessoal</span>; e também
          imagens e entradas de texto (<span className='italic'>prompts</span>)
